<template>
  ...
  <div
    ...
    class="relative overflow-hidden before:absolute before:bg-top bg-contain before:w-full before:h-full before:-z-[1] before:transform before:-translate-x-1/2 py-20"
  >
