<template>
  ...
  <div class="bg-white">
	<main class="w-full max-w-md mx-auto p-6 py-20">
		<div class="mt-7 bg-white border border-primary-900 rounded-xl shadow-lg">
			<div class="p-4 sm:p-7">
				<div class="text-center">
					<h1 class="block text-2xl font-bold text-gray-800">Sign in</h1>
					<p class="mt-2 text-sm text-font"> Don't have an account yet? <a href="#" class="text-accent decoration-2 hover:underline font-medium">
                Sign up here
              </a></p>
				</div>
				<div class="mt-5">
					<button type="button" class="w-full py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border-black border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-gray-800 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800">
						<svg width="46" height="47" viewBox="0 0 46 47" fill="none" class="w-4 h-auto">
					...
					<form>
						...
						<div class="mt-3 flex">
							<div>
								<label for="remember-me" class="text-xs">By submitting this form I have read and acknowledged the <a href="https://machintel.com/privacy-policy" target="_blank" class="text-blue-600 decoration-2 underline font-medium">Privacy policy</a></label>
							</div>
						</div>
						<div class="mt-6 grid">
							<button type="submit" class="text-white btn rounded-md bg-accent-2">Submit</button>
						</div>
					</form>
				</div>
			</div>
